...
layui.use(['layer', 'form'], function () {
    ...
    function oneQuestion_getsumofPerson_table() {
        ...
        $.ajax({
            url: "http://www.overlove.xin/ssm/getproblemscore?lesson="+oneQuestion_subject+"&classid="+classId+"&index="+oneQuestion_questionNumber
        ...
        console.log("sumSCore: "+temp_oneQuestion_sumScore);
        //数据通过测试，正确
        console.log("oneQuestion_stuJson1: "+oneQuestion_stuJson1.length);
        for(var i=0;i<oneQuestion_stuJson1.length;i++){
            console.log(oneQuestion_stuJson1[i]+" ");
            temp_oneQuestion_stus1 += oneQuestion_stuJson1[i] + " ";  //如果temp_oneQuestion_stus1未初始化，将显示undentified
        }
        console.log("oneQuestion_stuJson2: "+oneQuestion_stuJson2.length);
        for(var i=0;i<oneQuestion_stuJson2.length;i++){
            console.log(oneQuestion_stuJson2[i]+" ");
            temp_oneQuestion_stus2 += oneQuestion_stuJson2[i] + " ";
        }
        console.log("oneQuestion_stuJson3: "+oneQuestion_stuJson3.length);
        for(var i=0;i<oneQuestion_stuJson3.length;i++){
            console.log(oneQuestion_stuJson3[i]+" ");
